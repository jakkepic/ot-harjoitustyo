...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_konstruktori_asettaa_saldon_oikein(self):
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 9 euroa")
    ...
    def test_syo_edullisesti_onnistuu_kun_saldo_on_tasan_hinnan_verran(self):
    	self.kortti.syo_edullisesti()
    	self.kortti.syo_edullisesti()
    	self.kortti.syo_edullisesti()
    	self.kortti.syo_edullisesti()
    ...
    def test_syo_maukkaasti_onnistuu_kun_saldo_on_tasan_hinnan_verran(self):
